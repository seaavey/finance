<template>
  <div>
    ...
    <div v-if="loading" key="loading" class="mx-auto w-full max-w-3xl space-y-6">
      ...
      <div
        class="flex items-center justify-between rounded-3xl border border-border/50 p-6"
      >
      ...
      >
        <div class="flex items-center gap-4">
          ...
          <div class="space-y-0.5">
            ...
            <p class="text-xl font-bold">{{ formatCurrency(transaction.amount, transaction.currency) }}</p>
