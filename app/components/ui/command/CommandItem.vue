...
<template>
  ...
  >
    <slot />
    <HugeiconsIcon :icon="CheckIcon" class="ml-auto opacity-0 group-has-data-[slot=command-shortcut]/command-item:hidden group-data-[checked=true]/command-item:opacity-100" />
  </ListboxItem>
</template>
