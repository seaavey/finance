# Rekomendasi Fitur — Finance App

> Daftar fitur potensial, diurut dari high impact ke low impact.
...
| #   | Fitur                    | Deskripsi                                                            |
| --- | ------------------------ | -------------------------------------------------------------------- |
| 5   | **Tags/labels**          | Label tambahan di luar kategori, bisa cross-category (#liburan, etc) |
| 6   | **Laporan tahunan**      | Annual report: total, kategori terbesar, perbandingan tahun lalu     |
| 7   | **Shared goals partner** | Goals yang bisa dicicil berdua                                       |
| 8   | **Cash flow calendar**   | Lihat transaksi di tampilan kalender                                 |
| 9   | **Pin/protect app**      | Passcode/biometrik buat buka app                                     |
