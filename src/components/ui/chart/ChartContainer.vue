...
<template>
  <div
    ...
    :class="
      cn(
        'flex h-full w-full flex-col justify-center text-xs [&_.tick_text]:!fill-muted-foreground [&_.tick_line]:!stroke-border/50 [&_[data-vis-xy-container]]:h-full [&_[data-vis-xy-container]]:w-full',
        props.class,
      )
    "
    :style="{
