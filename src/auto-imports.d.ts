...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly calculateSpendingByCategory: UnwrapRef<
      (typeof import('./lib/budget-util'))['calculateSpendingByCategory']
    >
    ...
    readonly mutationWithReturn: UnwrapRef<
      (typeof import('./lib/query-wrapper'))['mutationWithReturn']
    >
    ...
    readonly useSubscriptions: UnwrapRef<
      (typeof import('./composables/useSubscriptions'))['useSubscriptions']
    >
    ...
    readonly useTransactionSummary: UnwrapRef<
      (typeof import('./composables/useTransactions'))['useTransactionSummary']
    >
